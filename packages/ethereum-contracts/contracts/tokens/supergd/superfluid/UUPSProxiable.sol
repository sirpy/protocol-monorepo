...
import { UUPSUtils } from "../../../upgradability/UUPSUtils.sol";
import {
    Initializable
 ...
 */
abstract contract UUPSProxiableGD is Initializable {
    /**
    ...
    function _updateCodeAddress(address newAddress) internal {
        ...
        require(
            proxiableUUID() == UUPSProxiableGD(newAddress).proxiableUUID(),
